...
import { deleteCategory, getCategoriesByAdmin } from "service/AdminService";
...
const ManageCategory = () => {
  ...
  const getData = async () => {
    let res = await getCategoriesByAdmin(debouncedSearchTerm);
    if (res) {
  ...
  return (
    <div className="user">
      ...
      <AddCategory open={open} handleEdit={handleOpen}></AddCategory>
      <UpdateCategory
        open={edit}
